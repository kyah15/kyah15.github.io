// These functions will work together to get weather information 
// for the current location and populate a web page with DataCue.
...
//       let windSpeedId = data.properties.windSpeed.value; 
//       let windDirectionId = data.properties.windDirection.value;
//       let feelsLikeId = data.properties.heatIndex.value;
//       let weatherSummaryId = data.properties.textDescription;    
//       console.log('Current temperature, wind speed, wind direction, feels like temp and weather summary are: ' + currentTempId, windSpeedId, windDirectionId, feelsLikeId, weatherSummaryId); 
